        ...
        while(it.hasNext()) {
            ...
            if (dist <= check && currentlyAt.equals("")) {
                ...
                if (!test) {
                    ...
                    current = toComp;
                    Firebase messageFirebase = MainActivity.mainFireBase.child("users").child(AddFriend.partner).child("messages");
                    messageFirebase.setValue("Your Partner Has Visited " + pair.getKey());
